...
import { UseResetPasswordErrorType, UseVerifyOtpType } from "@/types/user.types";
...
export const useVerifyOtpHook = () => {
   ...
   const [resetPasswordData, setResetPasswordData] = useState<UseVerifyOtpType>({ email: email, otp: "" } as UseVerifyOtpType);
